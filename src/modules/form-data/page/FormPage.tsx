...
export const FormPage: FC = () => {
  return (
    <div className="relative min-h-dvh w-full overflow-x-clip bg-[#24150b] text-[#171310] lg:h-dvh lg:overflow-hidden">
      {/* ============================================================ */}
      ...
      {/* ============================================================ */}
      {/* CONTENT — zero scrolling, positioned per user marks          */}
      {/* ============================================================ */}
      <div className="relative z-10 mx-auto flex min-h-dvh w-full max-w-8xl flex-col justify-between px-5 py-3 sm:px-8 lg:h-full lg:min-h-0 lg:px-12 lg:py-4 xl:px-16 xl:py-5">
        <main className="flex w-full flex-1 flex-col items-center justify-between gap-8 py-2 lg:min-h-0 lg:flex-row lg:gap-6 lg:py-0 xl:gap-8">
          {/* ================= LEFT — EDITORIAL (Moved UP and LEFT per arrows) ================= */}
          <section
            aria-label="Introduction"
            className="animate-fade-in-left flex h-full w-full max-w-[540px] flex-col justify-between py-1 lg:w-[420px] xl:w-[460px]"
          >
            <div>
              {/* Family Always Together — moved down & right into open space per user arrow */}
              <div className="pointer-events-none absolute left-10 top-14 select-none ml-28 lg:ml-48">
              ...
              {/* Heading moved UP & LEFT */}
              <h1 className="mt-36 font-serif leading-[0.95] tracking-tight">
                <span className="block text-[52px] sm:text-[62px] xl:text-[68px] font-bold text-[#111111]">
                  Hi,
                </span>
                <span className="mt-0.5 block text-[40px] sm:text-[48px] xl:text-[52px] font-bold text-[#111111]">
                  This is
                </span>
                <span className="relative mt-0.5 inline-block text-[54px] sm:text-[64px] xl:text-[72px] font-bold text-[#8a5225]">
                  Nayansh
                  <svg
                    viewBox="0 0 300 14"
                    aria-hidden="true"
              ...
              <div className="mt-2.5 xl:mt-3.5">
                <p className="font-serif text-[26px] sm:text-[30px] xl:text-[34px] leading-[1.1] text-[#111111]">
                  I am updating
                  <br />
                  my <em className="italic font-semibold text-[#8a5225]">family diary.</em>
                </p>

                <p className="mt-1.5 font-sans text-[14px] sm:text-[15px] xl:text-[16px] leading-[1.5] text-[#2b2620]">
            ...
            {/* 4 highlights */}
            <div className="mt-2 -ml-8 xl:mt-3 grid grid-cols-4 gap-2 sm:gap-2.5">
              {HIGHLIGHTS.map((item) => {
                const Icon = item.icon;
                return (
                  <div key={item.label + item.sub} className="flex flex-col items-center text-center">
                    <div className="flex h-[48px] w-[48px] sm:h-[52px] sm:w-[52px] xl:h-[56px] xl:w-[56px] items-center justify-center rounded-full border border-[#c9a86a]/70 bg-[#fffdf6]/85 shadow-sm transition-transform hover:scale-105">
                      <Icon className="h-[20px] w-[20px] xl:h-[22px] xl:w-[22px] text-[#1d1a15]" strokeWidth={1.8} />
                    </div>
                    <p className="mt-1 font-sans text-[10px] xl:text-[11px] font-medium leading-[1.25] text-[#2b2620]">
                      {item.label}
                      <br />
                      {item.sub}
                    </p>
            ...
            {/* Thank you signature — caps + rule centred under the script */}
            <div className="mt-2 w-fit select-none xl:mt-3">
              <p className="font-script text-[56px] sm:text-[64px] xl:text-[72px] leading-[1.05] text-[#6b4423] -rotate-[3deg]">
                Thank You <span className="align-top text-[30px]">♡</span>
              </p>
              <p className="mt-1.5 text-center font-sans text-[10px] xl:text-[11px] font-medium tracking-[0.32em] text-[#6b6259] uppercase">
                For being a part
                <br />
                of my life
              </p>
              <div className="mx-auto mt-2.5 h-px w-[70px] bg-[#a98552]" />
            </div>
          </section>

          {/* ================= MIDDLE — POLAROID (With Good Food note moved left per marks) ================= */}
          <section aria-label="Nayansh photo" className="flex shrink-0 items-center justify-center lg:px-2">
            <div
              className="animate-fade-in relative lg:-mt-2"
              style={{ animationDelay: '120ms', animationFillMode: 'both' }}
            >
              {/* Good Food note — moved left into open space per user arrow */}
              <div className="pointer-events-none absolute -top-12 -left-36 xl:-left-44 z-20 hidden select-none md:block">
          ...
          {/* ================= RIGHT — FORM CARD (Shifted up-right per user marks) ================= */}
          <section
            aria-label="Family details form"
            className="animate-fade-in flex shrink-0 justify-center lg:justify-end lg:-mt-6 lg:-mr-1 xl:-mt-8"
